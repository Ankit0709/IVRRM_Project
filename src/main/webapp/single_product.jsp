...
<!-- End Header Area -->
	...
	Product product=HibernateSessionProvider.getSession().get(Product.class,p_id); %>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="<%=product.getPics() %>" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="<%=product.getPics() %>" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3></h3>
						<h2>Rs. <%=product.getPrice() %></h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> :<%=product.getCategory() %></a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p style="color:grey;font-size:20px;"><%=product.getDesc() %></p>
						...
						<div class="card_area d-flex align-items-center">
							<a class="primary-btn" href="addCart?p_id=<%=product.getP_id()%>">Add to Cart</a>

...
<div class="section-title">
               ...
               <h1  style="font-weight: 50px; font-size: 40px; color: black; text-align: center;margin-top:100px">
                    Shops In The Karol Bagh Market </h1>
               </div>
...
<%
  ...
  Query query=session2.createQuery("from Vendor where city='Delhi' and market='Karol Bagh Market' ");

			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							<h4>Registered Your Shop?</h4>
							<p>Registered your shop on our website for easy selling of your items.</p>
							<a class="primary-btn" href="vendor_registration.jsp">Create an Account</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="vendorLogin" method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="email" class="form-control" id="email" name="vendor_email" placeholder="Email ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Id'">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="password" name="vendor_password" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
							</div>
							<div class="col-md-12 form-group">
								<div class="creat_account">
									<input type="checkbox" id="f-option2" name="selector">
									<label for="f-option2" style="color:black;">Keep me logged in</label>
								</div>
							</div>
							<div class="col-md-12 form-group">
